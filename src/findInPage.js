...
function setBackStyle() {
  ...
  const backLine = creatElement('find-back-line');
  ...
  const backCover = creatElement('find-back-cover');
...
function setForwardStyle() {
  ...
  const forwardLine = creatElement('find-forward-line');
  ...
  const forwardCover = creatElement('find-forward-cover');
...
function setCloseStyle() {
  ...
  const closeInner1 = creatElement('find-close-inner1');
  ...
  const closeInner2 = creatElement('find-close-inner2');
